...
class ConfigSpecification {
    ...
    removeExistingFriend() {
        ...
        if(this.jsonConfig.numberOfFriends == 0){
            return `You can not remove friends - you don't have any more`
        }
    }
    ...
    removeExistingPhoto() {
        ...
        if(this.jsonConfig.numberOfPhotos == 0){
            return `You can not remove photos - you don't have any more`
        }
    }
    ...
    removeExistingVideo() {
        ...
        if(this.jsonConfig.numberOfVideos == 0){
            return `You can not remove videos - you don't have any more`
        }
    }
